...
public class IntercomTest {
    ...
    public void setUp() {
        ...
        for (int i = 1; i <= 3; i++) {
            ...
            user.setName("User " + i);
            user.setRemoteCreatedAt(new Date(1270000000L * 1000));
            ...
            company.setCompanyId("company" + i);
            ...
            company.setCustomAttributes(companyCustomData);
...
//        assertThat((String)user.getCustomAttributes().get("custom_data_1"), is("test"));
//        assertThat((Double)user.getCustomAttributes().get("custom_data_2"), is(7.0));
...
//        assertThat(user.getCompanyIds()[0], is("company1"));
    ...
    public void getUserByEmail() {
        ...
        assertThat(user.getRemoteCreatedAt(), is(new Date(1270000000L * 1000)));
        assertThat(user.getCreatedAt(), is(not(nullValue())));
        assertThat((String)user.getCustomAttributes().get("custom_data_1"), is("test"));
        assertThat((Double)user.getCustomAttributes().get("custom_data_2"), is(7.0));
        ...
        assertThat(user.isUnsubscribedFromEmails(), is(false));
        assertThat(user.getCompanies()[0].getCompanyId(), is("company2"));
    }
...
//        assertThat(created.getRemoteCreatedAt(), is(new Date(1260000000L * 1000)));
//        assertThat((String)created.getCustomAttributes().get("custom_data_1"), is("hoge"));
//        assertThat((Double)created.getCustomAttributes().get("custom_data_2"), is(777.0));
...
//        assertThat(created.getCompanyIds()[0], is("new.company"));
    ...
    public void updateUser() {
        ...
        assertThat((String)user.getCustomAttributes().get("custom_data_1"), is("updated"));
    }
...
//        assertThat((String) company.getCustomAttributes().get("company_custom_data_1"), is("sample"));
//        assertThat((Double) company.getCustomAttributes().get("company_custom_data_2"), is(77.0));
    }
